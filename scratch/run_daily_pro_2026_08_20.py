...
def generate_report_pro(template_id, output_filename, date_str):
    ...
    system_instruction = (
        ...
        "3. 🚨 REAL-DATA ONLY MODE: ห้ามใช้ข้อมูลสมมติ ห้ามใช้ชื่อบริษัทสมมติ (เช่น InnovateTech, GlobalBank) ห้ามใช้ตัวเลขจำลอง "
        ...
        f"5. ข้อมูลราคาหุ้น ราคาทองคำ ดัชนีทางเทคนิคัล และปัจจัยข่าวสารทั้งหมด ต้องสอดคล้องตรงตามวันที่เป้าหมาย ({date_str}) อย่างเคร่งครัด\n"
    )
