...
## 3. ARCT (Arcturus Therapeutics)
**[ที่มา: Fintel, Exchange Reports, SEC Filings ณ วันที่ 24 ก.ค. 2026]**

### 1. Company Overview
*   **ชื่อบริษัท:** Arcturus Therapeutics Holdings Inc.
*   **Ticker:** ARCT (ทดแทน ASTS ที่เป็นหุ้น Mid-Cap ราคา $58)
*   **Sector:** Healthcare
*   **Industry:** Biotechnology
*   **Market Cap:** Small Cap (~$164M)
*   **ราคาปัจจุบัน:** $5.69 (ย่อตัวลงมาสร้างฐานสะสมช่วง $5.60 - $5.80)
*   **ปริมาณการซื้อขาย (Volume):** 46,138 หุ้น

### 2. Price Action Analysis
*   **Intraday Movement:** ราคาเคลื่อนไหวในลักษณะทรงตัวบีบอัดในกรอบแคบ มีแนวโน้มสะสมหุ้นบริเวณแนวรับหลัก
*   **Momentum Strength:** อ่อนแรงลงเนื่องจากวอลุ่มการซื้อขายเบาบางลงในจังหวะทำฐาน แต่ภาพรวมยังรักษาโครงสร้างแนวรับได้แข็งแกร่ง
*   **Insight:** การเคลื่อนไหวอยู่ในลักษณะเตรียมเลือกทาง คล้ายกับโครงสร้างสะสมระยะสั้น

### 3. Volume Analysis
*   **Short Interest Data:** ปริมาณหุ้นชอร์ตสะสมสูงอย่างน่าตกใจอยู่ที่ **29.11% ของ Float** (ข้อมูลอ้างอิงจากรอบรายงานล่าสุด)
*   **Short Interest Ratio (Days to Cover):** สูงถึง **15.5 วัน** (ถือเป็นระดับที่สูงมากอย่างยิ่งในกลุ่ม Small Cap)
*   **Insight:** ด้วย Days to Cover ระดับ 15.5 วัน หากมีแรงซื้อสู้หรือเบรกทะลุกรอบสะสม ฝั่ง Short จะต้องใช้เวลานานมากในการปิดสถานะทั้งหมด ซึ่งพร้อมทริกเกอร์ Short Squeeze ที่รุนแรงและลากยาวได้ง่าย

### 4. News & Catalyst Analysis
*   **ข่าวล่าสุด:** ความคืบหน้าการทดลองยาและวัคซีนกลุ่ม mRNA และความร่วมมือกับพันธมิตรการวิจัยระดับโลก
*   **Insight:** ข้อมูลผลการศึกษาทางคลินิกเป็นตัวเร่งหลักที่จะกระตุ้นการซื้อกลับ

### 5. Financial Health
*   **Insight:** มีเงินทุนสนับสนุนการทำวิจัยและพัฒนาวัคซีนเพียงพอในระยะสั้น แต่กระแสเงินสดจะขึ้นอยู่กับหลักไมล์การทดลองเป็นหลัก

### 6. Market Sentiment
*   **FOMO Level:** ต่ำ (ผู้เล่นกำลังรอดูจังหวะของตลาด)
*   **Insight:** การที่ราคาหุ้นยังเงียบเหงาและวอลุ่มแห้งเป็นลักษณะเด่นก่อนเกิดแรงระเบิดจาก Short Squeeze 

### 7. Technical Analysis
*   **Trend Structure:** ทดสอบและสะสมพลังในบริเวณกรอบล่างของพื้นที่ Sideway
*   **Support/Resistance Zone:** แนวรับหลัก $5.50 / แนวต้าน $6.50
*   **Insight:** จุดผ่าน $6.50 จะเป็นตัวกระตุ้นหลักในการไล่ราคาของระบบ

### 8. Risk Analysis
*   **ระดับความเสี่ยง:** **ความเสี่ยงสูงมาก**
*   **คำเตือน:** ระวังสภาพคล่องที่อาจเบาบางลงและแรงกดดันหากราคาหลุดแนวรับ $5.50
...
*   **หุ้นที่เข้าเกณฑ์ลุ้นเกิด Short Squeeze แรงที่สุด:** **ARCT** (ปริมาณชอร์ตสะสมกว่า 29% ของ Float, Days to Cover สูงถึง 15.5 วัน) และ **AMPG** (ชอร์ตสูงเกือบ 29% ของ Float) โครงสร้างกราฟมีโอกาสดีดตัวกลับแรง
...
**⚠️ หุ้นเสี่ยงที่สุดของวัน:** **ARCT** - ปริมาณการชอร์ตสะสมและ Days to Cover ที่สูงมาก หากไม่สามารถเบรกทะลุจุดสะสมได้ อาจโดนฝั่ง Short กดดันต่อ
...
*   [Fintel: Arcturus Therapeutics (ARCT) Short Interest, Float Details & Borrowing Rates](https://fintel.io/)
