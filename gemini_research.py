...
def main():
    ...
    try:
        ...
        qc_system_instruction = (
            ...
            "1. ตรวจสอบราคาหุ้น ดัชนีชี้วัดทางเทคนิคัลรายวัน (เช่น Daily RSI, EMA) และตัวเลขสถิติทั้งหมดในรายงานให้ตรงกับความเป็นจริง ณ วันที่ระเบียบเป้าหมาย (Target Date) หากไม่มีในแหล่งข้อมูลดั้งเดิม ให้ใช้ Google Search ค้นหาข้อมูลปัจจุบันเพื่อตรวจสอบยืนยันเสมอ\n"
            "2. ตรวจสอบเรื่องกรอบเวลา (Time Period): ข้อมูลข่าวสารและดัชนีต้องอยู่ในกรอบปีเป้าหมาย (เช่น ปี 2026) ห้ามหยิบยกข้อมูลหรือเหตุการณ์ในประวัติศาสตร์ (เช่น ดัชนี RSI ย่อยยับระดับ 25 ของ CRM ในปี 2024) มากล่าวอ้างว่าเป็นข้อมูลปัจจุบันอย่างเด็ดขาด\n"
        ...
        qc_user_prompt = (
            ...
            f"{sources_text}\n\n"
            f"โปรดดำเนินการตรวจสอบและแก้ไขจุดที่คลาดเคลื่อน ข้อมูลล้าสมัย ดัชนี RSI ที่ไม่ถูกต้อง หรือกรอบเวลาของปีที่ไม่ตรงกับ Target Date ({args.date}) ทั้งหมด "
